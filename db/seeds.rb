...
3.times do
Recipe.create!(user: mel, name: "Aspergesoep", summary: "Smaakvolle aspergesoep met een rommig tintje", description: lorem, kitchen: "Nederlands", course: "Voorgerecht", season: "Lente", number_of_persons: 4, prep_time: 15, photo: File.open(Rails.root.join("db/fixtures/images", "aspergesoep.jpg")))
Recipe.create!(user: mel, name: "Lasagna Pollo", summary: "Lasange met kip en paprika", description: lorem, kitchen: "Italiaans", course: "Hoofdgerecht", prep_time: 30, season: "Zomer", number_of_persons: 2, photo: File.open(Rails.root.join("db/fixtures/images", "lasagna.jpg")))
Recipe.create!(user: koen, name: "Chocolade mouse", summary: "Een mouse met chocolade stukjes", description: lorem, kitchen: "Frans", course: "Nagerecht", prep_time: 20, season: "Herfst", number_of_persons: 4, photo: File.open(Rails.root.join("db/fixtures/images", "mouse.jpg")))
end
